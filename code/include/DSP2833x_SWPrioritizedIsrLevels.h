...
#define	INT3PL      12       // Group3 Interrupts (PIEIER3)	PWM
#define	INT4PL      2        // Group4 Interrupts (PIEIER4)
#define	INT5PL      2        // Group5 Interrupts (PIEIER5)
#define	INT6PL      2        // Group6 Interrupts (PIEIER6)
#define	INT7PL      3        // DMA
#define	INT8PL      3        // reserved
#define	INT9PL      4        // Group9 Interrupts (PIEIER9)
#define	INT10PL     4        // reserved
#define	INT11PL     4        // reserved
#define	INT12PL     4        // reserved
#define	INT13PL     13       // XINT13
#define	INT14PL     14       // INT14 (TINT2)
#define	INT15PL     15       // DATALOG
#define	INT16PL     6        // RTOSINT
// ÏµÍ³Ä¬ÈÏ  2 1 4 2 2 3 0 0 3 0 0 0 4 4 4 4
...
#define	G85PL       0        // SCIRXINTC   (SCI-C)
#define	G86PL       0        // SCITXINTC   (SCI-C)
...
#define	G94PL       0        // SCITXINTB   (SCI-B)
