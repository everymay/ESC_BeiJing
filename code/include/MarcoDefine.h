...
/*************************************以下核心板IO口未引出**********************************************/
	 ...
	 * 1，断开。
	 */
    #define GET_MAIN_CONTACT_ACTION_A GpioDataRegs.GPCDAT.bit.GPIO79
	 ...
	 * 1：断开。
	 */
    #define GET_BYPASS_CONTACT_ACTION_A GpioDataRegs.GPCDAT.bit.GPIO78
	 ...
	 * 1：断开。
	 */
    #define GET_MAIN_CONTACT_ACTION_B GpioDataRegs.GPEDAT.bit.GPIO151
	 ...
	 * 0：闭合；
	 * 1：断开。WY*/
    #define GET_BYPASS_CONTACT_ACTION_B GpioDataRegs.GPEDAT.bit.GPIO150
	 ...
	 * 1，断开。
	 * */
    #define GET_MAIN_CONTACT_ACTION_C GpioDataRegs.GPCDAT.bit.GPIO77
	 ...
	 * VAL = 1：灯亮。
	 */
	#define GET_RUNNING_LED GpioDataRegs.GPEDAT.bit.GPIO158
	 ...
	 * VAL = 1：灯亮。
	 */
	#define GET_FAULT_LED GpioDataRegs.GPBDAT.bit.GPIO42
...
/*B相：初始状态(正常停机)*/
#define STATE_EVENT_STANDBY_B 0

/*B相预充电。WY*/
#define STATE_EVENT_RECHARGE_B        1

/*B相运行*/
#define STATE_EVENT_RUN_B             2               //正常运行

/*B相：主动停机状态*/
#define STATE_EVENT_STOP_B            3

/*B相待机状态。WY*/
#define STATE_EVENT_WAIT_B 4
...
/*C相：初始状态(正常停机)*/
#define STATE_EVENT_STANDBY_C 0
