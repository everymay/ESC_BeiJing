        ...
        USHORT usNRegs, eMBRegisterMode eMode)
{
    ...
    pusRegHoldingBuf = usMRegHoldBuf[ucMBMasterGetDestAddress(pStu) - 1];
        ...
        USHORT usNCoils, eMBRegisterMode eMode)
{
    ...
    pucCoilBuf = ucMCoilBuf[ucMBMasterGetDestAddress(pStu) - 1];
 ...
 * @return result
 */
eMBErrorCode eMBMasterRegDiscreteCB(struct ModbusSlaveStru *pStu, UCHAR * pucRegBuffer, USHORT usAddress, USHORT usNDiscrete )
{
    eMBErrorCode    eStatus = MB_ENOERR;
    USHORT          iRegIndex , iRegBitIndex , iNReg;
    ...
    pucDiscreteInputBuf = ucMDiscInBuf[ucMBMasterGetDestAddress(pStu) - 1];
