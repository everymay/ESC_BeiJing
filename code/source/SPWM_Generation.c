...
{
    EPwm3Regs.AQCSFRC.bit.CSFA = 0; //解除PWM-3-A的软件强制状态
    EPwm4Regs.AQCSFRC.bit.CSFA = 0; //解除PWM-4-A的软件强制状态
    EPwm3Regs.AQCSFRC.bit.CSFB = 0; //解除PWM-3-B的软件强制状态
    EPwm4Regs.AQCSFRC.bit.CSFB = 0; //解除PWM-4-B的软件强制状态
}
...
{
    EPwm5Regs.AQCSFRC.bit.CSFA = 0; //解除PWM-5-A的软件强制状态
    EPwm6Regs.AQCSFRC.bit.CSFA = 0; //解除PWM-6-A的软件强制状态
    EPwm5Regs.AQCSFRC.bit.CSFB = 0; //解除PWM-5-B的软件强制状态
    EPwm6Regs.AQCSFRC.bit.CSFB = 0; //解除PWM-6-B的软件强制状态
}
...
{
    EPwm7Regs.AQCSFRC.bit.CSFA = 0; //解除PWM-7-A的软件强制状态
    EPwm8Regs.AQCSFRC.bit.CSFA = 0; //解除PWM-8-A的软件强制状态
    EPwm7Regs.AQCSFRC.bit.CSFB = 0; //解除PWM-7-B的软件强制状态
    EPwm8Regs.AQCSFRC.bit.CSFB = 0; //解除PWM-8-B的软件强制状态
}
